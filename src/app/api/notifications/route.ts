...
const SOFT_SKILLS_NOTIFICATIONS: ParticipantNotification[] = [
  {
    id: 'notif-ss-round2-live',
    title: '🎭 Soft Skills League Round 2 Live',
    message: 'Executive Communication & Crisis Leadership sprint round is now active! Submit your structured scenario response before 5:00 PM.',
    created_at: new Date(Date.now() - 1000 * 60 * 15).toISOString(),
    read: false,
    category: 'SOFT_SKILLS',
    link: '/dashboard?tab=soft-skills',
    actionTab: 'soft-skills',
    priority: 'HIGH',
  },
  {
    id: 'notif-ss-pitch-score',
    title: '🎙️ Impromptu Pitch & Debate Score: 94/100',
    message: 'Skill League Jury evaluated your 3-minute technical pitch. Score: 94/100 (Top 5% in Clarity & Audience Engagement). Review rubric feedback.',
  ...
  {
    id: 'notif-ss-panel-slot',
    title: '👥 Soft Skills Panel Evaluation Slot Confirmed',
    message: 'Your live panel interview slot #3 with senior faculty & industry evaluators is confirmed for today at 3:30 PM.',
  ...
  },
  {
    ...
    message: "Dean of Academics & Skill League Jury awarded you the 'Advanced Negotiator & Communicator' credential (+50 Domain 2 Credits).",
  ...
  {
    id: 'notif-ss-leaderboard-top5',
    title: '🏅 Inter-Department Soft Skills Top 5 Rank',
    message: 'Your cumulative communication and negotiation sprint points placed you in Rank #4 across all participating engineering departments.',
